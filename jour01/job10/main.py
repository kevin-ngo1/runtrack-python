...
montant_initial += 5000 + gain_annuel_1
...
gain_annuel_final = montant_initial * (taux_de_rendement_annuel / 100)

print("Le montant final de l'investissement est de",montant_initial,"euros et un gain total de",gain_annuel_final,"euros.")
